...
import { Clock, AlertCircle, CheckCircle2, MoreVertical, User, Mail } from 'lucide-react';
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from './ui/Card';
import { Button } from './ui/Button';
import { Badge } from './ui/Badge';

export const TicketList = ({ tickets, onUpdateStatus, onAssign }) => {
    ...
    <div className="space-y-4">
      {tickets.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 py-12 dark:border-slate-800">
          ...
          <p className="text-lg font-medium text-slate-500">No active tickets</p>
