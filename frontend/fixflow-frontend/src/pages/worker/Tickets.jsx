...
export const WorkerTickets = () => {
    ...
    const myTickets = tickets.filter(t => t.reportedBy === user?.name);
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-3xl font-blod">My Tickets</h2>
            {myTickets.length === 0 ? (
                <p className="text-state-500">You haven't reported any issues yet.</p>
            ):(
                ...
                <CardTitle className="text-base font-bold">{t.machineName}</CardTitle>
                            ...
                            <CardContent className="space-y-2">
                                ...
                                <div className="flex items-center gap-3 text-xs text-slate-400">
                                    <Badge variant="secodary">{t.priority}</Badge>
